...
export const live = {
  ...
  nearExit: false,
  doorUse: null as { id: string; t: number; dir: "in" | "out"; opened: boolean } | null,
  doorReach: false,
  houseHold: 0,
  houseFace: false,
  cave: false,
  ...
  carry: null as null | "cat" | "cucco" | "frog",
  nearPet: null as null | "cat" | "cucco" | "frog",
  stillT: 0,
  haySoft: 0,
  pigRide: 0,
  pigX: 0,
  ...
  pigYaw: 0,
  tinyT: 0,
  hat: null as null | "pumpkin" | "kite" | "mask",
  nearHat: null as null | "pumpkin" | "kite" | "mask",
  appleFed: 0,
  flowers: 0,
  leafN: 0,
  bellT: 0,
